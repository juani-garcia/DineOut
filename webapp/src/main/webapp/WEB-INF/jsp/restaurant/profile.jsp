                    ...
                    <c:forEach items="${sections}" var="section">
                        <div class="flex_row">
                            ...
                            <a class="btn-large waves-effect waves-light btn-floating default_red modal-trigger"
                               href="#delete_section_confirm_modal${section.id}">
                                <i class="material-icons left">delete</i>
                            </a>
                            <div id="delete_section_confirm_modal${section.id}" class="modal confirm_delete_modal_height">
                                    ...
                                    <div class="flex_row">
                                        ...
                                        <div class="margin_l_5px">
                                            <a class="btn-small waves-effect waves-light btn-floating default_red modal-trigger"
                                               href="#delete_item_confirm_modal${item.id}">
                                                <i class="material-icons left">delete</i>
                                            </a>
                                            <div id="delete_item_confirm_modal${item.id}"
