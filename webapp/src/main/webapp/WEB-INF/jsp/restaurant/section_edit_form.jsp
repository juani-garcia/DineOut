...
<c:url value="/restaurant/section/${section.id}/edit" var="postPath"/>
        ...
        <div class="section">
            <div class="row rounded shadowed white">
                <div class="col s6 offset-s3">
                    <div class="row">
                        <h5 class="white bold"><spring:message code="restaurant.section.edit.form.header"/></h5>
                    </div>
                    <div class="row">
                    ...
                    <div class="row center flex_row">
                        ...
                        <button type="submit" name="action"
                            ...
                            <spring:message code="restaurant.section.edit.form.submit"/>
