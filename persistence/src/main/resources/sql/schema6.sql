...
ALTER TABLE menu_section DROP CONSTRAINT IF EXISTS menu_item_ordering_unique;
ALTER TABLE menu_section ADD CONSTRAINT menu_item_ordering_unique UNIQUE(restaurant_id, ordering) DEFERRABLE INITIALLY DEFERRED;
