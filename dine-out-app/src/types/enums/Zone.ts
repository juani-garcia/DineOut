export class Zone {
  ...
  static readonly JOSEINGENIEROS = new Zone('JOSEINGENIEROS', 'José Ingenieros')
  static readonly INGENIEROBUDGE = new Zone('INGENIEROBUDGE', 'Ingeniero Budge')
  static readonly INGENIEROALLAN = new Zone('INGENIEROALLAN', 'Ingeniero Allan')
  static readonly INGENIEROADOLFOSOURDEAUX = new Zone('INGENIEROADOLFOSOURDEAUX', 'Ingeniero Adolfo Sourdeaux')
  static readonly GUILLERMOHUDSON = new Zone('GUILLERMOHUDSON', 'Guillermo Hudson')
  static readonly GRANDBOURG = new Zone('GRANDBOURG', 'Grand Bourg')
  static readonly GONZALEZCATAN = new Zone('GONZALEZCATAN', 'González Catán')
  static readonly GOBERNADORCOSTA = new Zone('GOBERNADORCOSTA', 'Gobernador Costa')
  static readonly GERLIL = new Zone('GERLIL', 'Gerli (Lanús)')
  static readonly GERLIA = new Zone('GERLIA', 'Gerli (Avellaneda)')
  static readonly FRANCISCOALVAREZ = new Zone('FRANCISCOALVAREZ', 'Francisco Álvarez')
  static readonly FLORIDAOESTE = new Zone('FLORIDAOESTE', 'Florida Oeste')
  static readonly FLORESTA = new Zone('FLORESTA', 'Floresta')
  static readonly FLORES = new Zone('FLORES', 'Flores')
  static readonly EZPELETAOESTE = new Zone('EZPELETAOESTE', 'Ezpeleta Oeste')
  static readonly ESTEBANECHEVERRIA = new Zone('ESTEBANECHEVERRIA', 'Esteban Echeverría')
  static readonly ELPATO = new Zone('ELPATO', 'El Pato')
  static readonly ELPALOMAR = new Zone('ELPALOMAR', 'El Palomar')
  static readonly ELLIBERTADOR = new Zone('ELLIBERTADOR', 'El Libertador')
  static readonly ELJAGUEL = new Zone('ELJAGUEL', 'El Jagüel')
  static readonly DONTORCUATO = new Zone('DONTORCUATO', 'Don Torcuato')
  static readonly DONORIONE = new Zone('DONORIONE', 'Don Orione')
  static readonly DOCKSUD = new Zone('DOCKSUD', 'Dock Sud')
  static readonly DIQUELUJAN = new Zone('DIQUELUJAN', 'Dique Luján')
  static readonly CUARTELV = new Zone('CUARTELV', 'Cuartel V')
  static readonly COLEGIALES = new Zone('COLEGIALES', 'Colegiales')
  static readonly COGHLAN = new Zone('COGHLAN', 'Coghlan')
  static readonly CLAYPOLE = new Zone('CLAYPOLE', 'Claypole')
  static readonly CIUDADEVITA = new Zone('CIUDADEVITA', 'Ciudad Evita')
  static readonly CHURRUCA = new Zone('CHURRUCA', 'Churruca')
  static readonly CHACARITA = new Zone('CHACARITA', 'Chacarita')
  static readonly CARLOSSPEGAZZINI = new Zone('CARLOSSPEGAZZINI', 'Carlos Spegazzini')
  static readonly CARAPACHAY = new Zone('CARAPACHAY', 'Carapachay')
  static readonly CAMPODEMAYO = new Zone('CAMPODEMAYO', 'Campo de Mayo')
  static readonly BOEDO = new Zone('BOEDO', 'Boedo')
  static readonly BILLINGHURST = new Zone('BILLINGHURST', 'Billinghurst')
  static readonly BERAZATEGUIOESTE = new Zone('BERAZATEGUIOESTE', 'Berazategui Oeste')
  ...
  static readonly BERNALOESTE = new Zone('BERNALOESTE', 'Bernal Oeste')
  ...
  static readonly CANNINGE = new Zone('CANNINGE', 'Canning (Ezeiza)')
  static readonly CANNINGEE = new Zone('CANNINGEE', 'Canning (Esteban Echeverría)')
  ...
  static readonly CIUDADJARDINLOMASDELPALOMAR = new Zone('CIUDADJARDINLOMASDELPALOMAR', 'Ciudad Jardín Lomas del Palomar')
